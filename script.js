...
document.getElementById('exec').addEventListener('click', (event) => {
	...
	getData(street_name, building_number, year, plz, (err, data) => {
...
document.getElementById('download').addEventListener('click', (event) => {
	...
	download('abfuhrkalender_' + year + '_' + encodeURIComponent(street_name.replace('.', '')) + '_' + building_number + '.ics', document.getElementById('result').value)
})